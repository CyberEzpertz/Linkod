...
const RECT_WIDTH = 480; // Larger for kiosk
const RECT_HEIGHT = Math.round(RECT_WIDTH / 1.585); // ≈ 303

export default function KioskScanNationalIdPage() {
  ...
  const handleTakePicture = () => {
    ...
    if (ctx) {
      ...
      router.push("/kiosk/confirmation/confirm");
    }
  };
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col justify-end overflow-hidden bg-black">
      ...
      <div className="relative z-20 flex w-full justify-center pb-16">
        <Button
          variant="default"
          size="lg"
          className="w-[60%] max-w-2xl py-8 text-2xl"
